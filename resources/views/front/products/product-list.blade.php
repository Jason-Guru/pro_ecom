                                    ...
                                    <ul class="list-unstyled list-group">
                                        <li>
                                            <form action="{{ route('cart.store') }}" class="form-inline" method="post">
                                                ...
                                                <button id="add-to-cart-btn" type="submit" class="btn btn-default product-btn" data-toggle="modal" data-target="#cart-modal"> <i class="fa fa-cart-plus"></i> Add to cart</button>
                                            </form>
                                        </li>
                                        <li>  <button type="button" class="btn btn-default product-btn" data-toggle="modal" data-target="#myModal_{{ $product->id }}"> <i class="fa fa-eye"></i> Quick View</button>

                                        <li>  <a class="btn btn-default product-btn" href="{{ route('front.get.product', str_slug($product->slug)) }}"> <span class="text-light"><i class="fa fa-link"></i> Goto Product</span></a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
