    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h3 style="font-family:graphik">Get fresh our trends and unique gift ideas delivered right to your inbox. </h3>
                <p>This e-commerce app is built for demo purpose only <i class="fa fa-info text-danger"></i></p>
